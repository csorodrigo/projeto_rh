...
const mockApplications: ApplicationWithJob[] = [
  {
    ...
    ratings: [
      {
        ...
        rating: 4,
        category: "technical",
        comment: "Excelente conhecimento técnico",
        created_at: "2024-01-18T10:00:00Z",
      },
    ],
    applied_at: "2024-01-15T10:00:00Z",
    moved_to_current_stage_at: "2024-01-18T14:00:00Z",
    ...
    job: {
      ...
      pipeline_stages: [
        ...
        { id: "stage-2", name: "Entrevista Técnica", order: 2, color: "#8b5cf6" },
        { id: "stage-3", name: "Proposta", order: 3, color: "#10b981" },
      ],
...
const mockActivities: ActivityWithUser[] = [
  {
    ...
    action: "Entrevista técnica agendada",
    details: null,
        ...
        <div>
          <Tabs defaultValue="perfil" className="space-y-4">
            ...
            <TabsContent value="avaliacoes" className="space-y-4">
              <RatingSummary
                ratings={applications.flatMap((app) => app.ratings)}
              />
            </TabsContent>
          </Tabs>
        </div>
